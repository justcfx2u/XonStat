...
def main(global_config, **settings):
    ...
    config.add_route("rank_index0",      "/ranks/{game_type_cd:ctf|ffa|tdm|duel|ca|ft|race|ad}")
    config.add_view(rank_index,      route_name="rank_index0",      renderer="rank_index.mako")
    config.add_route("rank_index",     "/ranks/{game_type_cd:ctf|ffa|tdm|duel|ca|ft|race|ad}/{region:\d+}")
    config.add_view(rank_index,      route_name="rank_index",      renderer="rank_index.mako")

    config.add_route("rank_index_json0", "/ranks/{game_type_cd:ctf|ffa|tdm|duel|ca|ft|race|ad}.json")
    config.add_view(rank_index_json, route_name="rank_index_json0", renderer="jsonp")
    config.add_route("rank_index_json", "/ranks/{game_type_cd:ctf|ffa|tdm|duel|ca|ft|race|ad}/{region:\d+}.json")
