...
def main(global_config, **settings):
    ...
    config.add_route("rank_index",      "/ranks/{game_type_cd:ctf|ffa|tdm|duel|ca|ft|race}")
    config.add_view(rank_index,      route_name="rank_index",      renderer="rank_index.mako")

    config.add_route("rank_index_json", "/ranks/{game_type_cd:ctf|ffa|tdm|duel|ca|ft|race}.json")
